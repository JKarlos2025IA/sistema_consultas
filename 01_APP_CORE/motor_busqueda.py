...
class QueryRouter:
    def __init__(self, config_path='../03_CONFIG/config.json'):
        """
    ...
    def load_indices(self):
        """
        Carga todos los índices, chunks y metadatos especificados en el archivo de configuración.
        """
        print("--- INICIANDO CARGA DE ÍNDICES ---")
        
        for index_info in self.config['indices']:
            ...
            try:
                ...
                print(f"    -> ÉXITO: Índice '{nombre}' cargado.")
